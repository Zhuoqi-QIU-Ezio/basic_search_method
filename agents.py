...
import time
import util
import search_strategies, search_problems, heuristics
from actions import Directions, Actions
from graphics_utils import keys_waiting, keys_pressed, sleep
import random
...
class SearchAgent(object):
    ...
    def __init__(self, agent_index, fn='depth_first_search',
        ...
        if prob not in dir(search_problems) or not prob.endswith('Problem'):
            raise AttributeError, prob + ' is not a search problem type in agents.py.'
